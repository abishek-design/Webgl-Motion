...
const socialLinks = [
  {
    name: 'Email',
    href: 'mailto:abitechwork@gmail.com',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/abishek64/',
    icon: (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/abishek-design',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <AnimatedSection id="contact">
      <div className="text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white text-glow">Get In Touch</h2>
